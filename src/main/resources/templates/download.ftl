...
<div class="download_img">
    ...
    <#--</#if>-->
    <a class="download" href="javascript:;" data-clipboard-action="copy" data-clipboard-target="#t2" onclick="downloadit();">立即下载</a>
</div>
<div id="cover"></div>
<div id="guide">
...
<script type="text/javascript">
    ...
    function downloadit() {
        if (isWeiXin()) {
            ...
            var clipboard3 = new Clipboard('.download', {
                text: function(el) {
                    return "yqm-"+$("#t2").text();
                }
            });
            ...
            window.location.href = "http://pay-video.oss-cn-shenzhen.aliyuncs.com/zocoo_learn_apk/zgdx.apk";
        }
    }
